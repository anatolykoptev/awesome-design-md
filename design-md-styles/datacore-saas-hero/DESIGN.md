# Design System: Datacore SaaS Hero
...
Design a Linear-style dark SaaS hero with HLS background video and black overlay (bg-black/60). Poster thumbnail fading out when video starts. Glassmorphism pill badge with orange 'New' tag. Large headline ~76px with one word in Instrument Serif italic. Purple primary button and dark navy secondary. Mobile full-screen black overlay menu. Manrope global, Inter headings, Cabin buttons.
