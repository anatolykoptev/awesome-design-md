...
Render a 2D isolated text on a solid background. Font Family: @Syne Font, Color: Hex #FFFFFF, Background: #0B2B43, Tracking: Tight (-4%), Leading: 90%, Alignment: Strictly Left Aligned, Position: Center, Scale: 50%.
