...
Render a 2D isolated text on a solid background. Font Family: @Albert Sans font, Color: Hex #FFFFFF, Background: #0208F9, Tracking: Tight (-5%), Leading: 90%, Alignment: Strictly Left Aligned, Position: Center, Scale: 50%.
