...
Render a 2D isolated text on a solid background. Font Family: @IBM Plex Sans Font, Color: Hex #FFFFFF, Background: #09524F, Tracking: Tight (-3%), Leading: 90%, Alignment: Strictly Left Aligned, Position: Center, Scale: 50%.
