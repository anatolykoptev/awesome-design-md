# Design System: Coastal Mist

## 1\. Visual Theme & Atmosphere

Serene coastal UI using deep navy, pale seafoam, and soft slate blues. Ideal for saas de bem-estar, apps de meditação, turismo costeiro, imobiliárias de praia, clínicas e spas. AI-ready template.
...
Design a serene coastal UI using deep navy, pale seafoam, and soft slate blues. Create misty gradients, gentle shadows, and clean typography to evoke calm and trust.
