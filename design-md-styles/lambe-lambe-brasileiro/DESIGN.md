# Design System: Lambe-Lambe Brasileiro

## 1\. Visual Theme & Atmosphere

Brazilian lambe-lambe street poster style landing page. Ideal for landing pages, saas. AI-ready template. Lambe-Lambe Brasileiro style represents a modern trend in UI/UX web design focused on general.
...
Design a Brazilian lambe-lambe street poster style landing page. Use: bold typography as primary visual element, vibrant tropical colors (red, yellow, green, orange), woodcut/linocut style illustrations, visible borders, dense information layouts, high contrast for urban visibility, handcrafted folk aesthetic, graphic overlaps, textured backgrounds, activist-inspired messaging.
